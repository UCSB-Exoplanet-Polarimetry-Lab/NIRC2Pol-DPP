...
def mean_angle(angles, period=360.0):
    ...
    A plain ``np.mean`` is wrong whenever a set of angles straddles a wrap. For example,
    the AB Aur 2025-12-07 tutorial data has a cycle whose PARANG runs -112.75,
